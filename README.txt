...
required needed to create a midi file based on a progression. It is intended for guitarists who wish to quickly
write guitar chords into a midi file; however, plans to generalize MidiWrite are in the works.

MidiWrite takes in a series of chords and creates a midi file in the directory MidiWrite was ran. It accepts chords of
the following type:
...
The markup file will abstract the MidiWrite code so that the user can save progressions in a markup file
which will be processed by MidiWrite.
